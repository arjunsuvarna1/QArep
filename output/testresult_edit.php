...
require_once("include/testresult_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testresult_edit";
...
$page_layouts["testresult_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testresult_list";
...
$page_layouts["testresult_list"] = $layout;
...
$keys = array();
$keys["TestResult"] = postvalue("editid1");
