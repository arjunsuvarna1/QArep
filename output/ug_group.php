...
$nonAdminTablesArr[] = "testcases";
$nonAdminTablesArr[] = "testmodule";
$nonAdminTablesArr[] = "testresult";
$nonAdminTablesArr[] = "testscenarios";
$nonAdminTablesArr[] = "test_users";
$nonAdminTablesArr[] = "table1";
...
$wGroupTableName = $ug_connection->addTableWrappers( "qarep_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "qarep_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "qarep_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "qarep_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "qarep_ugmembers" );
