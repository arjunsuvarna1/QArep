...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testcases_masterprint";
...
$page_layouts["testcases_masterprint"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "table1" );
