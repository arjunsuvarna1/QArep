...
$layout = new TLayout("edit_bootstrap", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testcases_edit";
...
$page_layouts["testcases_edit"] = $layout;
...
$layout = new TLayout("list_bootstrap1", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testcases_list";
...
$page_layouts["testcases_list"] = $layout;
...
$layout = new TLayout("masterlist_bootstrap", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testscenarios_masterlist";
...
$page_layouts["testscenarios_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "table1_list";
$layout->blocks["center"] = array();
$layout->containers["gridcontrols"] = array();
$layout->container_properties["gridcontrols"] = array(  );
$layout->containers["gridcontrols"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["table1_list"] = $layout;
...
$keys = array();
$keys["TestScenrio_Id"] = postvalue("editid1");
$keys["TestCaseId"] = postvalue("editid2");
$keys["TestCase"] = postvalue("editid3");
$keys["Summary"] = postvalue("editid4");
$keys["TestEnvironment"] = postvalue("editid5");
$keys["TestResult"] = postvalue("editid6");
$keys["Comment"] = postvalue("editid7");
$keys["QA"] = postvalue("editid8");
