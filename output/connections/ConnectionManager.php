...
class ConnectionManager
{
	...
	{
		return $this->byId( "testrep_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "testrep_at_localhost";
		$data["connName"] = "testrep at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;testrep;;1"; //currently unused

		$this->_connectionsIdByName["testrep at localhost"] = "testrep_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "testrep";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=testrep;OPTION=3";
		// encription set
		...
		$connectionsData["testrep_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["testcases"] = "testrep_at_localhost";
		$connectionsIds["testmodule"] = "testrep_at_localhost";
		$connectionsIds["testresult"] = "testrep_at_localhost";
		$connectionsIds["testscenarios"] = "testrep_at_localhost";
		$connectionsIds["test_users"] = "testrep_at_localhost";
		$connectionsIds["admin_rights"] = "testrep_at_localhost";
		$connectionsIds["admin_members"] = "testrep_at_localhost";
		$connectionsIds["admin_users"] = "testrep_at_localhost";
		$connectionsIds["table1"] = "testrep_at_localhost";
