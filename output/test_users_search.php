...
require_once("include/test_users_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "test_users_search";
...
$page_layouts["test_users_search"] = $layout;
...
$params['shortTableName'] = 'test_users';
