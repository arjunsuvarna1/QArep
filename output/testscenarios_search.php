...
$layout = new TLayout("search_bootstrap", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testscenarios_search";
...
$page_layouts["testscenarios_search"] = $layout;
...
$params['shortTableName'] = 'testscenarios';
