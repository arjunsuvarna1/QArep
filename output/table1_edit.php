...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "table1_edit";
...
$page_layouts["table1_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testcases_masterlist";
...
$page_layouts["testcases_masterlist"] = $layout;
...
$keys = array();
$keys["TestDataID"] = postvalue("editid1");
