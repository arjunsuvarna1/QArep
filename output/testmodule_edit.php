...
require_once("include/testmodule_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testmodule_edit";
...
$page_layouts["testmodule_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testmodule_list";
...
$page_layouts["testmodule_list"] = $layout;
...
$keys = array();
$keys["TestModuleId"] = postvalue("editid1");
$keys["Module"] = postvalue("editid2");
