...
$layout = new TLayout("print_bootstrap", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testcases_print";
...
$page_layouts["testcases_print"] = $layout;
...
$layout = new TLayout("masterprint_bootstrap", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testscenarios_masterprint";
...
$page_layouts["testscenarios_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "table1_print";
$layout->blocks["top"] = array();
$layout->containers["pdf"] = array();
$layout->container_properties["pdf"] = array(  "print" => "none"  );
$layout->containers["pdf"][] = array("name"=>"printbuttons",
...
$layout->blocks["top"][] = "grid";
$page_layouts["table1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "testcases" );
