...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("test_users");
}
...
class tDAL
{
	var $tbltestrep_at_localhost__qarep_audit;
	var $tbltestrep_at_localhost__qarep_settings;
	var $tbltestrep_at_localhost__qarep_uggroups;
	var $tbltestrep_at_localhost__qarep_ugmembers;
	var $tbltestrep_at_localhost__qarep_ugrights;
	var $tbltestrep_at_localhost__Table1;
	var $tbltestrep_at_localhost__test_users;
	var $tbltestrep_at_localhost__testcases;
	var $tbltestrep_at_localhost__testmodule;
	var $tbltestrep_at_localhost__testresult;
	var $tbltestrep_at_localhost__testscenarios;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "qarep_audit", "varname" => "testrep_at_localhost__qarep_audit", "altvarname" => "qarep_audit", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "qarep_settings", "varname" => "testrep_at_localhost__qarep_settings", "altvarname" => "qarep_settings", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "qarep_uggroups", "varname" => "testrep_at_localhost__qarep_uggroups", "altvarname" => "qarep_uggroups", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "qarep_ugmembers", "varname" => "testrep_at_localhost__qarep_ugmembers", "altvarname" => "qarep_ugmembers", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "qarep_ugrights", "varname" => "testrep_at_localhost__qarep_ugrights", "altvarname" => "qarep_ugrights", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "Table1", "varname" => "testrep_at_localhost__Table1", "altvarname" => "Table1", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "test_users", "varname" => "testrep_at_localhost__test_users", "altvarname" => "test_users", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "testcases", "varname" => "testrep_at_localhost__testcases", "altvarname" => "testcases", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "testmodule", "varname" => "testrep_at_localhost__testmodule", "altvarname" => "testmodule", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "testresult", "varname" => "testrep_at_localhost__testresult", "altvarname" => "testresult", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		$this->lstTables[] = array("name" => "testscenarios", "varname" => "testrep_at_localhost__testscenarios", "altvarname" => "testscenarios", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
	}
