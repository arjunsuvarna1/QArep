...
$pageMask[$table] = $mask;
$tables[$table] = array("testcases", " " . "Test Cases");
$table = "testmodule";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("testmodule", " " . "Test Module");
$table = "testresult";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("testresult", " " . "Test Result");
$table = "testscenarios";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("testscenarios", " " . "Test Scenarios");
$table = "test_users";
$mask="";
			
$pageMask[$table] = $mask;
$tables[$table] = array("test_users", " " . "Test Users");
$table = "table1";
$mask="";
	$mask .= "A";
	$mask .= "E";
...
$pageMask[$table] = $mask;
$tables[$table] = array("table1", " " . "Table1");




$layout = new TLayout("admin_rights_list_bootstrap", "CoralBlueWave", "MobileBlueWave");
$layout->version = 3;
