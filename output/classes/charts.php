...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("testcases" == $this->chrt_array['tables'][0])
			return true;
		if("testmodule" == $this->chrt_array['tables'][0])
			return true;
		if("testresult" == $this->chrt_array['tables'][0])
			return true;
		if("testscenarios" == $this->chrt_array['tables'][0])
			return true;
		if("test_users" == $this->chrt_array['tables'][0])
			return true;
		if("qarep_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("test_users" == $this->chrt_array['tables'][0])
			return true;
		if("test_users" == $this->chrt_array['tables'][0])
			return true;
		if("table1" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
