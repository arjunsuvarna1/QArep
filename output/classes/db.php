...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "testrep_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "qarep_audit", "varname" => "testrep_at_localhost__qarep_audit", "altvarname" => "qarep_audit", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "qarep_settings", "varname" => "testrep_at_localhost__qarep_settings", "altvarname" => "qarep_settings", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "qarep_uggroups", "varname" => "testrep_at_localhost__qarep_uggroups", "altvarname" => "qarep_uggroups", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "qarep_ugmembers", "varname" => "testrep_at_localhost__qarep_ugmembers", "altvarname" => "qarep_ugmembers", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "qarep_ugrights", "varname" => "testrep_at_localhost__qarep_ugrights", "altvarname" => "qarep_ugrights", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "Table1", "varname" => "testrep_at_localhost__Table1", "altvarname" => "Table1", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "test_users", "varname" => "testrep_at_localhost__test_users", "altvarname" => "test_users", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "testcases", "varname" => "testrep_at_localhost__testcases", "altvarname" => "testcases", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "testmodule", "varname" => "testrep_at_localhost__testmodule", "altvarname" => "testmodule", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "testresult", "varname" => "testrep_at_localhost__testresult", "altvarname" => "testresult", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
			$dalTables[$conn->connId][] = array("name" => "testscenarios", "varname" => "testrep_at_localhost__testscenarios", "altvarname" => "testscenarios", "connId" => "testrep_at_localhost", "schema" => "", "connName" => "testrep at localhost");
		}
	}
