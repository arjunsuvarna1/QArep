...
class ProjectSettings
{
	...
	{
		if( $this->isLookupWhereCode( $field ) )
			return GetLWWhere( $field, $this->getEffectiveEditPage( $field ), $this->_table );
		else
	...
	*/
	...
	{
		return new ProjectSettings("test_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "testcases" ] = array( "url" => "testcases", "type" => 0 );
	$projectEntitiesReverse[ "testcases" ] = "testcases";
	$projectEntities[ "testmodule" ] = array( "url" => "testmodule", "type" => 0 );
	$projectEntitiesReverse[ "testmodule" ] = "testmodule";
	$projectEntities[ "testresult" ] = array( "url" => "testresult", "type" => 0 );
	$projectEntitiesReverse[ "testresult" ] = "testresult";
	$projectEntities[ "testscenarios" ] = array( "url" => "testscenarios", "type" => 0 );
	$projectEntitiesReverse[ "testscenarios" ] = "testscenarios";
	$projectEntities[ "test_users" ] = array( "url" => "test_users", "type" => 0 );
	$projectEntitiesReverse[ "test_users" ] = "test_users";
	...
	$projectEntities[ "table1" ] = array( "url" => "table1", "type" => 0 );
	$projectEntitiesReverse[ "table1" ] = "table1";
}
