...
class Labels {
	...
	public static function getPageTitleTempl( $table, $page, $lng = "")	
	{
		...
		if( strlen($templ) )
			return $templ;
		$ps = new ProjectSettings( $table );
		return RunnerPage::getDefaultPageTitle( $page, GoodFieldName($table), $ps );
	}
	 ...
	 * @return String
	 */
	function getPlaceholder( $table, $field, $lng )
	{
		global $placeHolders;
	 ...
	 * @return Boolean
	 */	
	function setPlaceholder( $table, $field, $placeHolder, $lng )
	{
		global $placeHolders;
