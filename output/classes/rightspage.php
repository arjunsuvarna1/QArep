...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "GroupID" ) .", ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "qarep_uggroups" ) ." order by ". $grConnection->addFieldWrappers( "Label" );
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "qarep_ugrights" )
	...
	{
		$rightWTableName = $this->connection->addTableWrappers( "qarep_ugrights" );
