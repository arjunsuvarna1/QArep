...
require_once("include/testscenarios_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testscenarios_edit";
...
$page_layouts["testscenarios_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "slate";
		$layout->customCssPageName = "testscenarios_list";
...
$page_layouts["testscenarios_list"] = $layout;
...
$keys["TestType"] = postvalue("editid2");
$keys["TestScenario"] = postvalue("editid3");
$keys["Summary"] = postvalue("editid4");
$keys["UAT"] = postvalue("editid5");
$keys["Module"] = postvalue("editid6");
